  ...
  return (
    <div className="flex min-h-screen items-center justify-center px-4 py-12">
      <div className="w-full max-w-md rounded-3xl border border-ink/10 bg-white/90 p-8 shadow-xl backdrop-blur">
        ...
        <p className="mt-2 text-sm text-ink/70">Log in to manage your tasks.</p>
        ...
        <p className="mt-4 text-sm text-ink/70">
          No account yet? <Link className="font-semibold text-ink underline" to="/signup">Sign up</Link>
        </p>
      </div>
    </div>
  );
